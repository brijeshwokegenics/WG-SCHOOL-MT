...
//                 <div className="hidden lg:flex items-center space-x-3 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg h-[40px]">
...
//       {/* Mobile Menu */}
//       <div className={`md:hidden transition-all duration-300 ease-in-out ${menuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
//         } overflow-hidden`}>
